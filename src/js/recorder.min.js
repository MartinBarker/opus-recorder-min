                    ...
                    i = function e() {
                        ...
                        (this.state = "inactive"),
                            (this.config = Object.assign(
                                {
                                    ...
                                    numberOfChannels: 1,
                                    recordingGain: 1,
                                    resampleQuality: 10, //was 3 before
                                    streamPages: !1,
                                    wavBitDepth: 16,
                            ...
                            (this.initialize = this.initWorklet().then(function () {
                                console.log('recorder.js, this.config=',t.config)
                ...
                (i.isRecordingSupported = function () {
                    ...
                    (i.prototype.close = function () {
                        return (
                            ...
                            this.clearStream(),
                            this.encoder && (this.encoderNode.disconnect(), this.encoder.postMessage({ command: "close" })),
                    ...
                    (i.prototype.initAudioContext = function () {
                        (this.audioContext = this.config.sourceNode.context ? this.config.sourceNode.context : new n()),
                    ...
                    (i.prototype.initEncoder = function () {
                        ...
                        this.audioContext.audioWorklet
                            ? ((this.encoderNode = new AudioWorkletNode(this.audioContext, "encoder-worklet", { numberOfOutputs: 0 })), (this.encoder = this.encoderNode.port))
                    ...
                    (i.prototype.initWorker = function () {
                        ...
                        return (
                            ...
                            new Promise(function (n) {
                                ...
                                e.encoder.postMessage(Object.assign({ command: "init", originalSampleRate: e.audioContext.sampleRate, wavSampleRate: e.audioContext.sampleRate }, r));
                            })
                        );
                    }),
