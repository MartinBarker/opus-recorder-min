...
var asmLibraryArg = { c: _abort, e: _emscripten_memcpy_big, f: _emscripten_resize_heap, d: _fd_close, b: _fd_seek, a: _fd_write };
var asm = createWasm();
var ___wasm_call_ctors = (Module["___wasm_call_ctors"] = asm["h"]);
var _opus_encoder_create = (Module["_opus_encoder_create"] = asm["i"]);
var _opus_encode_float = (Module["_opus_encode_float"] = asm["j"]);
var _opus_encoder_ctl = (Module["_opus_encoder_ctl"] = asm["k"]);
var _opus_encoder_destroy = (Module["_opus_encoder_destroy"] = asm["l"]);
var _speex_resampler_init = (Module["_speex_resampler_init"] = asm["m"]);
var _speex_resampler_destroy = (Module["_speex_resampler_destroy"] = asm["n"]);
var _speex_resampler_process_interleaved_float = (Module["_speex_resampler_process_interleaved_float"] = asm["o"]);
var _malloc = (Module["_malloc"] = asm["p"]);
var _free = (Module["_free"] = asm["q"]);
var calledRun;
...
const OggOpusEncoder = function (config, Module) {
    ...
    this.config = Object.assign(
        { encoderApplication: 2049, encoderFrameSize: 20, encoderSampleRate: 48e3, maxFramesPerPage: 40, numberOfChannels: 1, originalSampleRate: 44100, resampleQuality: 3, serial: Math.floor(Math.random() * 4294967296) },
        config
    );
...
OggOpusEncoder.prototype.getChecksum = function (data) {
    ...
    for (var i = 0; i < data.length; i++) {
        checksum = (checksum << 8) ^ this.checksumTable[((checksum >>> 24) & 255) ^ data[i]];
    }
    return checksum >>> 0;
};
OggOpusEncoder.prototype.generateCommentPage = function () {
    ...
    segmentDataView.setUint32(4, 1936154964, true);
    segmentDataView.setUint32(8, 10, true);
    segmentDataView.setUint32(12, 1868784978, true);
    segmentDataView.setUint32(16, 1919247474, true);
    segmentDataView.setUint16(20, 21322, true);
    segmentDataView.setUint32(22, 0, true);
...
OggOpusEncoder.prototype.generateIdPage = function () {
    ...
    segmentDataView.setUint8(8, 1, true);
    segmentDataView.setUint8(9, this.config.numberOfChannels, true);
    segmentDataView.setUint16(10, 3840, true);
    ...
    segmentDataView.setUint8(18, 0, true);
    this.segmentTableIndex = 1;
...
OggOpusEncoder.prototype.generatePage = function () {
    ...
    pageBufferView.setUint32(0, 1399285583, true);
    pageBufferView.setUint8(4, 0, true);
    pageBufferView.setUint8(5, this.headerType, true);
    ...
    pageBufferView.setUint32(14, this.config.serial, true);
    pageBufferView.setUint32(18, this.pageIndex++, true);
    pageBufferView.setUint8(26, this.segmentTableIndex, true);
    page.set(this.segmentTable.subarray(0, this.segmentTableIndex), 27);
    page.set(this.segmentData.subarray(0, this.segmentDataIndex), 27 + this.segmentTableIndex);
    pageBufferView.setUint32(22, this.getChecksum(page), true);
...
OggOpusEncoder.prototype.initChecksumTable = function () {
    ...
    for (var i = 0; i < 256; i++) {
        var r = i << 24;
        for (var j = 0; j < 8; j++) {
            r = (r & 2147483648) != 0 ? (r << 1) ^ 79764919 : r << 1;
        }
        this.checksumTable[i] = r & 4294967295;
    }
};
...
OggOpusEncoder.prototype.initCodec = function () {
    ...
    this.encoderSamplesPerChannel = (this.config.encoderSampleRate * this.config.encoderFrameSize) / 1e3;
    ...
    this.encoderBufferPointer = this._malloc(this.encoderBufferLength * 4);
...
OggOpusEncoder.prototype.initResampler = function () {
    ...
    this._free(errLocation);
    this.resampleBufferIndex = 0;
    this.resampleSamplesPerChannel = (this.config.originalSampleRate * this.config.encoderFrameSize) / 1e3;
    ...
    this.resampleBufferPointer = this._malloc(this.resampleBufferLength * 4);
...
var module = module || {};
module.exports = { Module: Module, OggOpusEncoder: OggOpusEncoder };
